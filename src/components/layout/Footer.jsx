...
const exploreLinks = ["Buy Property", "Rent Property", "Commercial", "New Projects", "Plots & Land"];
const supportLinks = ["Help Center", "Privacy Policy", "Terms of Service", "Cookie Policy", "Sitemap"];
  ...
  return (
    <footer className="bg-navy text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-400 max-w-sm">
              India&apos;s most trusted real estate platform connecting buyers, sellers, renters, and agents across 500+ cities.
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 pt-8 border-t border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-white">+91 1800 123 4567</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-white">support@nesthub.in</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-8 pt-6 border-t border-gray-800 text-xs text-gray-500">
          <p>© 2026 NestHub Technologies Pvt. Ltd. All rights reserved.</p>
          <div className="flex items-center gap-3">
