    ...
    <MainLayout>
      <div className="bg-surface min-h-screen py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-navy mb-2">Properties for Rent</h1>
            <p className="text-muted">Find your ideal rental property</p>
          </div>
            ...
            <div className="lg:col-span-3">
              {filteredProperties.length > 0 ? (
                ...
                <div className="bg-white rounded-2xl border border-border p-12 text-center">
                  <p className="text-muted text-lg">No rental properties found matching your filters</p>
                </div>
              )}
            </div>
          </div>
